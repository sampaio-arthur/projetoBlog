...
return [
    ...
    'default' => [
        ...
        'persistent' => false,
        'host' => 'localhost',
        'username' => 'sampaio', // Seu nome de usuário do MySQL
        'password' => 'sua_senha', // Sua senha do MySQL
        'database' => 'blog', // Nome da sua base de dados 'blog'
        'timezone' => 'UTC',
        'flags' => [],
        'cacheMetadata' => true,
    ...
    'test' => [
        ...
        'persistent' => false,
        'host' => 'localhost',
        'username' => 'sampaio', // Mesmo usuário para o ambiente de teste
        'password' => 'sua_senha', // Mesma senha para o ambiente de teste
        'database' => 'blog_test', // Nome da base de dados de teste, se aplicável
        'timezone' => 'UTC',
        'flags' => [],
        'cacheMetadata' => true,
        'quoteIdentifiers' => false,
